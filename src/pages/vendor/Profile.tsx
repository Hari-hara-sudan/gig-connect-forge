import { User, Mail, Phone, MapPin, Camera, Store } from "lucide-react";
      ...
      <div className="max-w-2xl space-y-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl bg-secondary border border-border p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="font-display font-semibold text-foreground">StyleHub Studio</h3>
              <p className="text-sm text-muted-foreground">Beauty & Spa Vendor</p>
            </div>
          </div>

          <div className="space-y-4">
            {[
              { label: "Business Name", value: "StyleHub Studio", icon: Store },
              { label: "Owner Name", value: "Alex Johnson", icon: User },
              { label: "Email", value: "alex@stylehub.com", icon: Mail },
